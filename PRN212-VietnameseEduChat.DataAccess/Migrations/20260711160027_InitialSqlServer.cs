        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DailyQuestionLimit = table.Column<int>(type: "int", nullable: true),
                    MaxUploadSizeMb = table.Column<int>(type: "int", nullable: false),
                    MaxDocuments = table.Column<int>(type: "int", nullable: true),
                    AllowAiFeatures = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "ChunkingConfigurations",
                columns: table => new
                {
                    ChunkingConfigurationId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StrategyKey = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    StrategyName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    ChunkSize = table.Column<int>(type: "int", nullable: false),
                    ChunkOverlap = table.Column<int>(type: "int", nullable: false),
                    FixedSizeUnit = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChunkingConfigurations", x => x.ChunkingConfigurationId);
                    table.ForeignKey(
                        name: "FK_ChunkingConfigurations_Users_UpdatedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChunkingConfigurations_UpdatedBy",
                table: "ChunkingConfigurations",
                column: "UpdatedBy");
